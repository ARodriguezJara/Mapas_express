...
class TaqueriasService {
 ...
 async create(data) {
   console.log(data);
    ...
    `INSERT INTO tacolizador.taquerias(nombre, calidad, precio,
    comentario, latitud, longitud, pagina_fb)
    VALUES('${data.nombre}',
    ${data.calidad},${data.precio},'${data.comentario}',${data.latitud},${data.longitud},'${data.pagina_fb}')`
    );
      return result;
  }
 async find(){
